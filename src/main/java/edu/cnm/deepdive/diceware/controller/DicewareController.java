...
public class DicewareController {
  ...
  @Autowired
  public DicewareController(PassphraseGenerator generator, PassphraseRepository repository) {
  ...
  @PostMapping(value = "/passphrases", produces = MediaType.APPLICATION_JSON_VALUE)
